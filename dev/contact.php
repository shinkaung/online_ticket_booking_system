...
<body>
  ...
  <!---------------------------- Body Code --------------------------------------->
    <div id="contact">
        ...
        <div id="phone">
            <div id="phone-logo">
                <img src="images/website-phone.png" width="60px" height="60px">
            </div>
            <div id="phone-text">
                <h2>Please call us at</h2>
                <p>09 777 111 811, 09 76543 0471</p>
            </div>
        </div>
        <div id="or-text">
            <p>or</p>
        ...
        <div id="messenger">
        <div id="messenger-logo">
                <a href="https://m.me/MMBusTicket"><img src="images/website-messenger.png" width="60px" height="60px"></a>
            </div>
            <div id="messenger-text">
                <h3>Contact via Messenger</h3>
                <a href="https://m.me/MMBusTicket" style="color: black;">Messenger</a>
            </div>
        </div>
        </div>
    </div>
